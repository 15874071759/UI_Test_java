...
public class storypage extends basepage{
	...
	Locator creatStoryLink=getLocator("creatStoryLink");
	Locator linkStoryLink=getLocator("linkStoryLink");
	//导出数据frame
	...
	public void clickcreatStory(){
		click(creatStoryLink);
	}
	public void clicklinkStory(){
		click(linkStoryLink);
	}
	//
